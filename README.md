...
### 🎨 Non-Destructive Canvas Photo Editor
- **Dynamic HTML5 Canvas Pipeline**: Pixel-level adjustments applied instantly without layout reflows or CPU bottlenecks.
...
- **13 Built-in Presets**: Click to apply styles like *Vintage*, *Matte*, *Cyberpunk*, *Emerald*, or *High-Contrast Monochrome*.
- **Copy/Paste Adjustments**: Copy all sliders, presets, and healing points via `Ctrl + Shift + C` and batch apply to successive shots with `Ctrl + Shift + V`.
...
- **Synchronized Dual Viewports**: Display original and edited assets side-by-side with locked zoom and panning.
...
To build a optimized standalone executable installer:
